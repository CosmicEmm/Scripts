...
fetch_channel_to_sheet(
    channel_url="https://www.youtube.com/@MAPSNafsCenter/videos",
    channel_name="MAPS Nafs Center",
    n_videos=5,
    output_excel="all_channels.xlsx"
)
...
fetch_channel_to_sheet(
    channel_url="https://www.youtube.com/@assimalhakeem/videos",
    channel_name="Assim Al-Hakeem",
    n_videos=5,
    output_excel="all_channels.xlsx"
)